...
object ArtistAlbum extends SQLSyntaxSupport[ArtistAlbum] {
  ...
  override val tableName = "artist_album"
  ...
  def find(id: Int)(implicit session: DBSession): Option[ArtistAlbum] = {
    withSQL {
  ...
  def create(
    ...
    updatedAt: OffsetDateTime,
    deletedAt: Option[OffsetDateTime] = None,
    lockVersion: Int)(implicit session: DBSession): ArtistAlbum = {
    val generatedKey = withSQL {
      insert.into(ArtistAlbum).namedValues(
